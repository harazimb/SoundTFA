...
public class SoundThread extends Thread {
    ...
    public interface SoundIterator extends Iterable<Integer> {
        public int size();
    }
    ...
    final SoundIterator frequencies;
    final ToneCallback callback;
    boolean callback_done = false;

    public SoundThread(SoundIterator frequencies, ToneCallback callback) {
